...
from models import ttfs, ttfs_disc_qual
import audio
...
parser = argparse.ArgumentParser(description='Code to train the ttfs model WITH the visual quality discriminator')
...
if __name__ == "__main__":
    ...
    device = torch.device("cuda" if use_cuda else "cpu")
     ...
     # Model
    model = ttfs().to(device)
    disc = ttfs_disc_qual().to(device)
